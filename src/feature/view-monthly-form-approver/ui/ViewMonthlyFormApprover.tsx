...
interface ViewMonthlyFormProps {
  ...
  setIsModalVisible: (abc: boolean) => void;
}

const ViewMonthlyFormApprover: React.FC<ViewMonthlyFormProps> = ({ id,setIsModalVisible }) => {
...
export default ViewMonthlyFormApprover;
